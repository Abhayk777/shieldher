...
const steps = [
  {
    ...
    description: 'Take a screenshot of any chat conversation and upload it to ShieldHer. We accept all major image formats.',
  },
  {
    number: '02',
    title: 'AI Analyzes',
    description: 'Our AI reads and analyzes the conversation for harmful patterns, red flags, and potential legal violations.',
  },
  {
    number: '03',
    title: 'Get Results',
    description: 'Receive a detailed risk assessment with specific flags, legal insights, and safety recommendations.',
  },
];

const testimonials = [
  {
    quote: "ShieldHer gave me the clarity I needed. It identified manipulation patterns I couldn't see myself.",
    name: 'Sarah M.',
    role: 'Early User',
    initial: 'S',
  },
  {
    quote: 'The legal analysis feature was a game-changer. It helped my lawyer understand the situation immediately.',
    name: 'Priya K.',
    role: 'Advocate',
    initial: 'P',
  },
  {
    quote: 'Finally a tool that takes digital safety seriously. The AI is incredibly accurate at detecting subtle threats.',
    name: 'Aisha R.',
    role: 'Counselor',
    initial: 'A',
  },
          ...
          <div className={`container ${styles.statsBannerInner}`}>
            <ScrollReveal>
              <h2 className={styles.statsBannerTitle}>
                The backbone of<br />digital safety
              </h2>
            </ScrollReveal>
            <ScrollReveal delay={100}>
              <div className={styles.statsBannerGrid}>
                <div className={styles.statItem}>
                  ...
                  <span className={styles.statName}>screenshots analyzed with AI-powered insights</span>
                </div>
                <div className={styles.statItem}>
                  <span className={styles.statValue}>98%</span>
                  <span className={styles.statName}>detection accuracy across threat categories</span>
                </div>
                <div className={styles.statItem}>
                  <span className={styles.statValue}>&lt;30s</span>
                  <span className={styles.statName}>average analysis time per screenshot</span>
                </div>
                <div className={styles.statItem}>
                  <span className={styles.statValue}>24/7</span>
                  <span className={styles.statName}>always available when you need it most</span>
                </div>
              </div>
            </ScrollReveal>
          </div>
            ...
            <ScrollReveal>
              <div className={styles.sectionHeader}>
                ...
                <p className={styles.sectionSubtitle}>
                  Powerful AI tools designed specifically for detecting and analyzing
              ...
              <div className={styles.ctaCard}>
                <div className={styles.ctaContent}>
                  ...
                  <p className={styles.ctaSubtitle}>
                    Start analyzing your conversations today. It takes less than a
                    minute to sign up and get your first analysis.
                  </p>
          ...
          <div className="container">
            <div className={styles.footerInner}>
              ...
              <p className={styles.footerText}>
                © {new Date().getFullYear()} ShieldHer. Built with care for women&apos;s safety.
              </p>
            </div>
          </div>
        </footer>
